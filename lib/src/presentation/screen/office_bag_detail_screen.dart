...
class OfficeBagDetailScreen extends HookWidget {
  final Bag furniture;
  final int index;

  const OfficeBagDetailScreen(
      ...
      return AppBar(
        actions: [
          IconButton(
            splashRadius: 18.0,
            onPressed: () =>
                context.read<BagProvider>().addToFavorite(items[index]),
        ...
        child: Row(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                context.read<BagProvider>().addToCart(items[index]);
              },
