...
class FurnitureListView extends StatelessWidget {
  ...
  final Function(Bag furniture, int index)? onTap;
  final List<Bag> furnitureList;
  ...
  Widget _furnitureScore(Bag furniture) {
    return Row(
      children: [
  ...
  Widget _listViewItem(Bag furniture, int index) {
    Widget widget;
    ...
    return isHorizontal == true
        ? SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, index) {
                Bag furniture = furnitureList[index];
